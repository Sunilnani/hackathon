            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                image: DecorationImage(
                    image:NetworkImage("http://sowmyamatsa.pythonanywhere.com/media/AnyConv.com__mixed_nv_fried.jpg"),fit: BoxFit.cover
                ),
                color: Colors.red,
              ),),
                SizedBox(height: 20,),
                Row(
                 ...
                 children: [
                   ...
                   Container(
                     child: Text("\$9.64",style: TextStyle(color: Colors.green[700],fontWeight: FontWeight.w700,fontSize: 22),),
                   )
                 ],
                ),
                SizedBox(height: 15,),
